...
kubectl delete --kubeconfig kube/config -n astrolabe -f yaml/astrolabe-storage-class.aws.yaml
...
kubectl apply --kubeconfig kube/config -n astrolabe -f yaml/astrolabe-svc.aws.yaml 
